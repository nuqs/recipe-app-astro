...
class DetailFood extends StatefulWidget {
  ...
  final String rating;
  const DetailFood({Key? key, required this.item, required this.id, required this.imageUrl, required this.rating}) : super(key: key);
                          ...
                          child: BlocListener<DetailBloc, DetailState>(
                            ...
                            child: BlocBuilder<DetailBloc, DetailState>(builder: (context, state) {
                              ...
                              if (state is DetailFoodLoaded) {
                                List<FoodDetails> detail = state.detail;
                                // split the number and unit of the measurement
                                // if error, means improper backend
                                List<String> measurement = detail[0].strMeasure2!.split(" ");
                                                          ...
                                                          children: [
                                                            Container(
                                                              ...
                                                              child: ClipRRect(
                                                                ...
                                                                child: CachedNetworkImage(
                                                                  imageUrl: detail[0].strMealThumb!,
                                                                  fit: BoxFit.cover,
                                                                  errorWidget: (context, url, error) => const Icon(Icons.error),
                                                                ),
                                                              ),
